...
class MarginalityDepartmentsDatatable extends StatefulWidget {
  final List<MarginalityDepartments> data;
  final String selectedMarginality;
  final String selectedCurrency;
  const MarginalityDepartmentsDatatable({
    super.key,
    required this.data,
  ...
  @override
  State<MarginalityDepartmentsDatatable> createState() => _MarginalityDepartmentsDatatableState();
}
class _MarginalityDepartmentsDatatableState extends State<MarginalityDepartmentsDatatable> {
  ...
  List<MarginalityDepartments> _data = [];
  List<MarginalityDepartments> _unfilteredData = [];
  @override
  initState() {
    super.initState();
    _selectedCurrency = widget.selectedCurrency;
    _data = List<MarginalityDepartments>.from(widget.data.take(8));
