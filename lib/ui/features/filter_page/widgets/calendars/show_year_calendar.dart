...
class ShowYearCalendar extends StatelessWidget {
  final String selectedYear;
  const ShowYearCalendar({super.key, required this.selectedYear});
        ...
        child:SizedBox(
            ...
            child:SfDateRangePicker(
              ...
              onSelectionChanged: (DateRangePickerSelectionChangedArgs args) {
                ...
                sharedPref.setMarginalityPeriodYear('${DateFormat('dd/MM/yyyy').
                format(args.value)} - ${DateFormat('dd/MM/yyyy')
                .format(DateTime.utc(args.value.year, 12, 31))}');
                context.read<MarginalityFilterBloc>().
